...
<style>
    ...
    :root {
        ...
        --preview-color: #06B6D4; /* Cyan/Aqua */
        --archive-color: #EF4444;
        --accent-secondary: #F97316; /* Orange (Arsip Link) */
        --border-color: #E5E7EB;
        --text-color: #374151;
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td data-label="Kecamatan"><?php echo $row['Kecamatan'] ?? '-'; ?></td>
                    <td data-label="Kel/Desa"><?php echo $row['Desa'] ?? '-'; ?></td>
